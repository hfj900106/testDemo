...
public class ArithUtil {
     ...
     * @return 多个参数的和
     */
    public static double add(double... ss) {
     ...
     * @return 两个参数的积
     */
    public static double mulDown(double s1, double s2) {
        BigDecimal b1 = new BigDecimal(Double.toString(s1));
        BigDecimal b2 = new BigDecimal(Double.toString(s2));
     ...
     * @return 两个参数的积
     */
    public static double mulHalUp(double s1, double s2) {
        BigDecimal b1 = new BigDecimal(Double.toString(s1));
        BigDecimal b2 = new BigDecimal(Double.toString(s2));
...
//		} 
     ...
     * @return 两个参数的商
     */
    public static int roundHalfUp(double s1, double s2, int scale) {

        BigDecimal b1 = new BigDecimal(Double.toString(s1));
        BigDecimal b2 = new BigDecimal(Double.toString(s2));
        return b1.divide(b2).setScale(scale, BigDecimal.ROUND_HALF_UP).intValue();
    }
...
//		} 
    ...
    public static BigDecimal yuan2fen(BigDecimal yuan){
        ...
        return new BigDecimal("100").multiply(yuan);
    }
     ...
     * i:保留小数位数
     */
    public static BigDecimal fen2yuan(BigDecimal fen,int i){

        return fen.divide(new BigDecimal("100"),i, BigDecimal.ROUND_DOWN);
    }
     ...
     * i:保留整数
     */
    public static BigDecimal fen2zhengshu(BigDecimal fen){

        return fen.divide(new BigDecimal("100"),0, BigDecimal.ROUND_DOWN);
    }
