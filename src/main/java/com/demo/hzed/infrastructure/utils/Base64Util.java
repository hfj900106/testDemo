...
/**
 * Encodes binary data to plain text as Base64Util.
 *
 * Despite there being a gazillion other Base64Util implementations out there, this has been written as part of XStream as
 ...
 * other Base64Util tools to manipulate the data.
 *
