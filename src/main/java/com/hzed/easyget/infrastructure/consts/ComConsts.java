...
public class ComConsts {
     ...
     * 短信模板code
     */
    public static final String SMS_CONTENT_1 = "sms_content_1";
    public static final String SMS_CONTENT_2 = "sms_content_2";
    public static final String SMS_CONTENT_3 = "sms_content_3";
    public static final String SMS_CONTENT_4 = "sms_content_4";
    public static final String SMS_CONTENT_5 = "sms_content_5";
    public static final String SMS_CONTENT_6 = "sms_content_6";
