...
public class LoanBillLedger implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public static LoanBillLedger.Builder builder() {
        return new LoanBillLedger.Builder();
    }

    public static class Builder {
        private LoanBillLedger obj;

        public Builder() {
            this.obj = new LoanBillLedger();
        }
