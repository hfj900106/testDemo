...
public class AuthExample {
    ...
    public AuthExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public AuthExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public AuthExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private AuthExample example;

        protected Criteria(AuthExample example) {
            super();
            this.example = example;
        }

        public AuthExample example() {
            return this.example;
        }
