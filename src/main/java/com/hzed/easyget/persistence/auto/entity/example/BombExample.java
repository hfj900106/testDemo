...
public class BombExample {
    ...
    public BombExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public BombExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public BombExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public BombExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public BombExample orderBy(String ... orderByClauses) {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andIsUseLikeInsensitive(String value) {
            addCriterion("upper(is_use) like", value.toUpperCase(), "isUse");
            return (Criteria) this;
        }
    ...
    public static class Criteria extends GeneratedCriteria {
        private BombExample example;

        protected Criteria(BombExample example) {
            super();
            this.example = example;
        }

        public BombExample example() {
            return this.example;
        }
