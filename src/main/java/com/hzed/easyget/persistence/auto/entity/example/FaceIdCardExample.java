...
public class FaceIdCardExample {
    ...
    public FaceIdCardExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public FaceIdCardExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public FaceIdCardExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public FaceIdCardExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public FaceIdCardExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FaceIdCardExample example;

        protected Criteria(FaceIdCardExample example) {
            super();
            this.example = example;
        }

        public FaceIdCardExample example() {
            return this.example;
        }
