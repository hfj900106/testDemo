...
public class LoanBillLedgerExample {
    ...
    public LoanBillLedgerExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LoanBillLedgerExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LoanBillLedgerExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public LoanBillLedgerExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public LoanBillLedgerExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private LoanBillLedgerExample example;

        protected Criteria(LoanBillLedgerExample example) {
            super();
            this.example = example;
        }

        public LoanBillLedgerExample example() {
            return this.example;
        }
