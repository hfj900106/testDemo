...
public class UserRepaymentVisitExample {
    ...
    public UserRepaymentVisitExample() {
    ...
    public UserRepaymentVisitExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public UserRepaymentVisitExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public UserRepaymentVisitExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public UserRepaymentVisitExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public UserRepaymentVisitExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private UserRepaymentVisitExample example;

        protected Criteria(UserRepaymentVisitExample example) {
            super();
            this.example = example;
        }

        public UserRepaymentVisitExample example() {
            return this.example;
        }
