...
public class UserTokenExample {
    ...
    public UserTokenExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public UserTokenExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public UserTokenExample page(Integer page, Integer pageSize) {
        this.offset = page * pageSize;
        this.rows = pageSize;
        return this;
    }

    public UserTokenExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public UserTokenExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private UserTokenExample example;

        protected Criteria(UserTokenExample example) {
            super();
            this.example = example;
        }

        public UserTokenExample example() {
            return this.example;
        }
