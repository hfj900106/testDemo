...
<template>
     ...
     * does not deal with this comment. If you run the config.generator repeatedly, you will only retain the comment from the
     * initial run.
     * <p>
     *
     ...
     * with this comment. If you run the config.generator repeatedly, you will only retain the comment from the initial run.
     * <p>
     *
     * The default implementation does nothing.
     *
